...
-- Function: returns true only for the first-registered user (the app owner)
...
-- Restrict get_platform_stats to admins only
...
-- Restrict get_daily_activity to admins only
